...
1. **Node.js**: Ensure you have Node.js installed (v16 or higher is recommended).
...
1. Clone the repository:
    ```bash
    git clone https://github.com/your-repo/chrome-bug-report2.git
    cd chrome-bug-report2
    ```
...
With these steps, you can run and test the extension locally while ensuring all required environment variables are properly configured.
